...
const featuresData = [
  { icon: Fingerprint, title: 'Biometric Login', description: 'Face ID / Touch ID', benefit: 'Post-Password', color: 'from-cyan-400 to-blue-600' },
  { icon: Lock, title: 'WebAuthn Passkeys', description: 'Phishing-proof authentication', benefit: 'Military-grade', color: 'from-purple-400 to-pink-600' },
  { icon: Shield, title: 'ML Fraud Brain v5', description: 'Real-time 99.998% fraud detection', benefit: 'Always-On Protection', color: 'from-green-400 to-emerald-600' },
  { icon: Ban, title: 'On-Chain Fraud Ban', description: 'Permanent ban on Ethereum', benefit: 'Immutable Justice', color: 'from-red-400 to-rose-600' },
  { icon: Smartphone, title: '2FA (TOTP + Backup Codes)', description: 'Google Authenticator', benefit: 'Account Takeover Proof', color: 'from-yellow-400 to-orange-600' },
  { icon: Database, title: 'Encrypted Local Storage', description: 'IndexedDB + Crypto', benefit: 'Data Safe Offline', color: 'from-indigo-400 to-violet-600' },
];
    ...
    <div className="min-h-screen bg-black text-gray-100 font-sans relative overflow-hidden">
      ...
      <header className="relative z-20 p-6 flex justify-between items-center backdrop-blur-md bg-black/30 border-b border-cyan-500/30 animate-slideDown">
        ...
        <nav className="flex gap-6">
          <button className="text-cyan-300 hover:text-cyan-100 transition-colors font-medium relative group">
            Create Free Account
          ...
          <button className="px-6 py-2 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 rounded-lg text-white font-bold transition-all duration-300 shadow-lg shadow-cyan-500/50 hover:shadow-purple-500/50 hover:scale-105">
            Sign In
          </button>
        </nav>
      </header>
      ...
      <section className="relative z-10 text-center max-w-5xl mx-auto px-4 py-24 animate-fadeIn">
        ...
        <div className="flex justify-center gap-6 flex-wrap">
          <button className="group px-10 py-4 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 text-white font-bold rounded-full text-lg transition-all duration-300 transform hover:scale-110 shadow-2xl shadow-purple-500/50 relative overflow-hidden">
          ...
          <button className="px-10 py-4 border-2 border-cyan-400 text-cyan-300 hover:bg-cyan-400 hover:text-black font-bold rounded-full text-lg transition-all duration-300 transform hover:scale-110 shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/60">
            Sign In
          </button>
        </div>
      </section>
      ...
      <section className="relative z-10 w-full max-w-7xl mx-auto px-4 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {featuresData.map((feature, index) => {
          ...
          return (
            <div
              key={feature.title}
              className="group relative bg-gradient-to-br from-gray-900/80 to-black/80 p-8 rounded-2xl border-2 border-transparent hover:border-cyan-400/50 shadow-xl backdrop-blur-sm transition-all duration-300 hover:scale-105 animate-fadeInUp"
              style={{
      ...
      <section className="relative z-10 text-center py-20 px-4 animate-fadeIn" style={{ animationDelay: '1.5s' }}>
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-purple-900/40 to-cyan-900/40 p-12 rounded-3xl border border-purple-500/30 backdrop-blur-md">
          ...
          <button className="inline-block px-12 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-bold rounded-full text-xl transition-all duration-300 transform hover:scale-110 shadow-2xl shadow-purple-500/50 hover:shadow-cyan-500/50">
            Get Started Now
          </button>
        </div>
      </section>
